...
class GBC:
    ...
    def __init__(self,Xtrain,Xvalid,ytrain,yvalid,Xtest=None,random_seed=None,pca_comp=55,nest=150,lrate=0.1,mdepth=5,ssample=1,optimize=False,verbose=True):
    ...
    def _make_pipeline(self,n_comp,n,lr,md,ss):
        steps = [('pca',PCA(n_components=n_comp)),('GBC',GradientBoostingClassifier(n_estimators=n,learning_rate=lr,max_depth=md,subsample=ss,max_features='auto'))]
        pipe = Pipeline(steps)
        return pipe
